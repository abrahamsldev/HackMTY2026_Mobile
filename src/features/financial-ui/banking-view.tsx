...
const styles = StyleSheet.create({
  ...
  hero: { borderLeftWidth: 4, borderRadius: 16, padding: Spacing.xl, gap: Spacing.sm },
  ...
  search: { borderWidth: 1, borderRadius: 12, minHeight: 48, padding: Spacing.md, fontSize: 16 },
  expanded: { gap: Spacing.sm, padding: Spacing.md },
  schedule: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.md },
  dateTile: { padding: Spacing.md, borderRadius: 12, justifyContent: 'center', maxWidth: '100%' },
  scheduleBody: { flexGrow: 1, flexBasis: 160, gap: Spacing.xs },
});
