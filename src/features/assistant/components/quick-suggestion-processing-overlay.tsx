...
export type RequestProcessingOverlayProps = {
  ...
  pendingLabel?: string;
  /**
   * Coarse phase reported by the backend for the running turn, when there is
   * one to report. A2UI actions never stream a phase, so they leave it unset
   * and the label keeps its steady fallback copy.
   */
